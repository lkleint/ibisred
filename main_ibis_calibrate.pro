...
;
;;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PRO main_ibis_calibrate, lambda, date, cregion, wregion, $
...
;-------------------------------
     ...
     range=[ya,yb]
     ibis_scan_calibrate_xt, stokesin, xmtxl, xmtxr, tmtx, stokesout,range,wlobs,wlscan
...
;-------------------------------
     ...
     SAVE, /VERB, /COMP, FILENAME = outfilename, $ 
           mwld, simage, stokesout, xtalk, polfac, nb_expos, mask,$
