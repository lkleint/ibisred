;create overview plots of all calibrated 6302 data
...
files = file_search('*/6302*tatb*sav',count=nfiles)
...
;total polarizations
plot_image,total(abs(stokesout[x1:x2,y1:y2,*,1])>.01,3),ticklen=-.02,position=[p1x,p1y,p1x+dx,p1y+dy],title='total Q',/norm
plot_image,total(abs(stokesout[x1:x2,y1:y2,*,2])>.01,3),ticklen=-.02,position=[p2x,p1y,p2x+dx,p1y+dy],title='total U',/noer,/norm
plot_image,total(abs(stokesout[x1:x2,y1:y2,*,3])>.01,3),ticklen=-.02,position=[p3x,p1y,p3x+dx,p1y+dy],title='total V',/noer,/norm
...
plot,avg(stokesout[c1:c2,y1:y2,0,0],0),xtitle='y pixel',title='Continuum I',position=[p1x,p2y,p1x+dpx,p2y+dpy],/noer,$
     xthick=2,ythick=2,thick=2,charthick=2,/xs,yrange=[min(avg(stokesout[c1:c2,y1:y2,0:2,0],0)),max(avg(stokesout[c1:c2,y1:y2,0:2,0],0))],/ys
oplot,avg(stokesout[c1:c2,y1:y2,1,0],0),color=2
oplot,avg(stokesout[c1:c2,y1:y2,2,0],0),color=4
al_legend,['lambda='+string(wave[0],format='(F7.2)'),'lambda='+string(wave[1],format='(F7.2)'),'lambda='+string(wave[2],format='(F7.2)')],color=[0,2,4],lines=[0,0,0],box=0,position=[0,min(avg(stokesout[c1:c2,y1:y2,0:2,0],0))-200]

plot,avg(stokesout[c1:c2,y1:y2,0,1],0),xtitle='y pixel',title='Continuum Q',position=[p4x,p2y,p4x+dpx,p2y+dpy],/noer,$
     xthick=2,ythick=2,thick=2,charthick=2,/xs,yrange=[min(avg(stokesout[c1:c2,y1:y2,0:2,1],0)),max(avg(stokesout[c1:c2,y1:y2,0:2,1],0))],/ys
...
plot,avg(stokesout[c1:c2,y1:y2,0,2],0),xtitle='y pixel',title='Continuum U',position=[p5x,p2y,p5x+dpx,p2y+dpy],/noer,$
     xthick=2,ythick=2,thick=2,charthick=2,/xs,yrange=[min(avg(stokesout[c1:c2,y1:y2,0:2,2],0)),max(avg(stokesout[c1:c2,y1:y2,0:2,2],0))],/ys
...
plot,avg(stokesout[c1:c2,y1:y2,0,3],0),xtitle='y pixel',title='Continuum V',position=[p6x,p2y,p6x+dpx,p2y+dpy],/noer,$
     xthick=2,ythick=2,thick=2,charthick=2,/xs,yrange=[min(avg(stokesout[c1:c2,y1:y2,0:2,3],0)),max(avg(stokesout[c1:c2,y1:y2,0:2,3],0))],/ys
...
plot_image,stokesout[x1:x2,y1:y2,1,0],ticklen=-.02,position=[p1x,p3y,p1x+dximg,p3y+dyimg],/noer,title='Continuum images I,Q,U,V'
...
;stokes I,Q,U,V wing
plot_image,stokesout[x1:x2,y1:y2,9,0],ticklen=-.02,position=[p1x,p1y,p1x+dximg,p1y+dyimg],title='Line wing images I,Q,U,V'
plot_image,stokesout[x1:x2,y1:y2,9,1],ticklen=-.02,position=[p4x,p1y,p4x+dximg,p1y+dyimg],/noer
plot_image,stokesout[x1:x2,y1:y2,9,2],ticklen=-.02,position=[p5x,p1y,p5x+dximg,p1y+dyimg],/noer
plot_image,stokesout[x1:x2,y1:y2,9,3],ticklen=-.02,position=[p6x,p1y,p6x+dximg,p1y+dyimg],/noer

;stokes I,Q,U,V core
plot_image,stokesout[x1:x2,y1:y2,13,0],ticklen=-.02,position=[p1x,p4y,p1x+dximg,p4y+dyimg],title='Line core images I,Q,U,V',/noer
plot_image,stokesout[x1:x2,y1:y2,13,1],ticklen=-.02,position=[p4x,p4y,p4x+dximg,p4y+dyimg],/noer
plot_image,stokesout[x1:x2,y1:y2,13,2],ticklen=-.02,position=[p5x,p4y,p5x+dximg,p4y+dyimg],/noer
plot_image,stokesout[x1:x2,y1:y2,13,3],ticklen=-.02,position=[p6x,p4y,p6x+dximg,p4y+dyimg],/noer
